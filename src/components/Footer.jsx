...
const Footer = () => {
  return (
    <div className="container-fluid bg-success text-white footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
      <div className="container py-5">
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <h5 className="text-white mb-4">Wasiliana nasi</h5>
            <p><i className="fa fa-map-marker-alt me-3"></i>Mjini Magharibi, Zanzibar</p>
            <p><i className="fa fa-phone-alt me-3"></i>+255 000 000 000</p>
            <p><i className="fa fa-envelope me-3"></i>info@zema.com</p>
          </div>

          <div className="col-lg-3 col-md-6">
            <h5 className="text-white mb-4">Tovuti linganifu</h5>
            <a className="btn btn-link text-white" href="">Wizara ya .....</a>
            <a className="btn btn-link text-white" href="">Baraza la Wawakilishi</a>
            <a className="btn btn-link text-white" href="">Wizara ya Kilimo Zanzibar</a>
            <a className="btn btn-link text-white" href="">Terms & Condition</a>
            <a className="btn btn-link text-white" href="">Support</a>
          </div>

          <div className="col-lg-3 col-md-6">
            <h5 className="text-white mb-4">Jarida (Newsletter)</h5>
            <p>Jisajili ili kupata taarifa mpya kutoka ZEMA.</p>
            <div className="position-relative mx-auto" style={{ maxWidth: "400px" }}>
              <input className="form-control bg-transparent w-100 py-3 ps-4 pe-5 text-white border-white" type="text" placeholder="Barua pepe yako" />
              <button type="button" className="btn btn-light py-2 position-absolute top-0 end-0 mt-2 me-2">Jisajili</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid bg-dark text-white-50 py-3">
        <div className="container">
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              &copy; <a className="text-white" href="#">ZEMA</a>, Haki zote zimehifadhiwa.
            </div>
            <div className="col-md-6 text-center text-md-end">
              Imetengenezwa na Kitengo cha TEHAMA
            </div>
          </div>
        </div>
      </div>
