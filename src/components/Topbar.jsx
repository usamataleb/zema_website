        ...
        <div className="col-lg-3 px-4 text-end d-flex justify-content-end align-items-center">
          <div className="h-100 d-inline-flex align-items-center me-3">
            <small style={{ color: "white" }}>
              {" "}
              <a href="http://" target="_blank"></a> e-office{" "}
            </small>
          </div>
          <div className="h-100 d-inline-flex align-items-center me-3">
            ...
            <small style={{ color: "white" }}>
              {" "}
              <a href="http://" target="_blank"></a> e-Proz{" "}
            </small>
          </div>
          ...
          <div className="h-100 d-inline-flex align-items-center me-3">
            ...
            <small style={{ color: "white" }}>
              {" "}
              <a href="http://" target="_blank"></a> Staff-Mail{" "}
            </small>
          </div>
          ...
          <div className="h-100 d-inline-flex align-items-center me-3">
            ...
            <small style={{ color: "white" }}>
              {" "}
              <a href="http://" target="_blank"></a> ZanVibali{" "}
            </small>
          </div>
          ...
          <div className="h-100 d-inline-flex align-items-center me-3">
            ...
            <small style={{ color: "white" }}>
              {" "}
              <a href="http://" target="_blank"></a> ZanMalipo{" "}
            </small>
          </div>

          {/* Social icons */}
          <div className="d-inline-flex align-items-center">
            <a className="text-white-50 ms-2" href="#">
